...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("127.0.0.1","root","","myhmsdb");
        ...
        $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
          ...
          if(mysqli_num_rows($check_query)==0){
            ...
            if (isset($_SESSION['pid'])) {
              ...
              $insert_query = mysqli_prepare($con, "INSERT INTO appointmenttb (pid, fname, lname, gender, email, contact, doctor, docFees, appdate, apptime, userStatus, doctorStatus) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '1', '1')");

              mysqli_stmt_bind_param($insert_query, "isssssssss", $pid, $fname, $lname, $gender, $email, $contact, $doctor, $docFees, $appdate, $apptime);
              ...
              echo "<script>alert('Error: User session information is missing. Please log in again.');</script>";
          }
            // if($query)
            // {
